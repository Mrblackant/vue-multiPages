...
!function (a) {
  ...
  function l(a) {
    ...
    function f(a) {
      var b = Number(Q[V]["max" + a]), c = Number(Q[V]["min" + a]), d = a.toLowerCase(), e = Number(U[d]);
    ...
    function g() {
      ...
      var c = a.origin, d = Q[V] && Q[V].checkOrigin;
  ...
  function w(c, d) {
    ...
    function l() {
      var a = Q[x] && Q[x].firstRun, b = Q[x] && Q[x].heightCalculationMethod in P;
  ...
  if ("undefined" != typeof window) {
    var G = 0, H = !1, I = !1, J = "message", K = J.length, L = "[iFrameSizer]", M = L.length, N = null,
      O = window.requestAnimationFrame, P = {max: 1, scroll: 1, bodyScroll: 1, documentElementScroll: 1}, Q = {},
      R = null, S = "Host Page", T = {
        autoResize: !0,
        bodyBackground: null,
        bodyMargin: null,
        bodyMarginV1: 8,
